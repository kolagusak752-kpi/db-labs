...
9)Заявки-команди може брати участь у багатьох зустрічах, а у зустрічі беруть участь дві заявки-команди заявки (N:M, так як команди завжди дві, в сутність зустріч додано два атрибути: айді першої команди та айді другої команди).
